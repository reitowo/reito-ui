...
const meta = { title: 'AI/AgentTaskCard', component: AgentTaskCard, args: { title: '检查工作区布局', description: '确认输入区、工具调用和预览面板的状态。', status: 'running', context: 'reito-ui / local-example', updatedLabel: '本地示例' }, decorators: [Story => <StoryFrame><Story /></StoryFrame>] } satisfies Meta<typeof AgentTaskCard>;
export default meta;
type Story = StoryObj<typeof meta>;
export const Guidelines: Story = { name: '运行中',};
...
export const Error: Story = { name: '失败', args: { status: 'error' } };
export const LocalActions: Story = { name: '交互场景：打开与继续任务', render: () => <AgentTaskCardDemo /> };
