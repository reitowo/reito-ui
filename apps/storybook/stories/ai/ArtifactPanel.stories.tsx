...
const meta = { id: "ai-artifactpanel", title: "AI/ArtifactPanel 产物面板", component: ArtifactPanel, args: { title: 'workspace.ts', versions: [{ id: 'v1', label: '版本 1', status: 'ready', preview: <p className="text-sm">本地静态预览</p>, code: 'export const density = "compact";', language: 'typescript' }] }, decorators: [Story => <StoryFrame><Story /></StoryFrame>], parameters: { docs: { description: { component: '产物的版本、预览和代码组合。预览由调用方提供 ReactNode，组件不会运行任意源码，也不生成假 diff。' } } } } satisfies Meta<typeof ArtifactPanel>;
export default meta;
...
export const VersionsAndPreview: Story = { name: "交互 · 版本、编辑与关闭",
