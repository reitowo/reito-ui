...
const meta = { id: "ai-attachmentlist", title: "AI/AttachmentList 附件列表", component: AttachmentList, args: { items: [{ id: 'guide', name: 'design-language.md', sizeLabel: '12 KB', status: 'ready' }] }, decorators: [Story => <StoryFrame><Story /></StoryFrame>] } satisfies Meta<typeof AttachmentList>;
export default meta;
