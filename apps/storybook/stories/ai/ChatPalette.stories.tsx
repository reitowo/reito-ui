...
const meta = { id: "ai-chatpalette", title: "AI/ChatPalette 对话命令面板", component: ChatPalette } satisfies Meta<typeof ChatPalette>;
export default meta;
export const Playground: StoryObj<{ title: string; disabled: boolean; shortcut: boolean; fail: boolean; empty: boolean; running: boolean }> = { name: "参数调试",
...
export const Empty = { name: "状态 · 空内容", ...Playground, args: { ...Playground.args, empty: true } };
export const Failure = { name: "状态 · 失败", ...Playground, args: { ...Playground.args, fail: true } };
export const Running = { name: "状态 · 运行中", ...Playground, args: { ...Playground.args, running: true } };
export const Disabled = { name: "状态 · 禁用", ...Playground, args: { ...Playground.args, disabled: true } };
export const Shortcut = { name: "交互 · 快捷键", ...Playground, args: { ...Playground.args, shortcut: true } };

export const PendingSelection: StoryObj<typeof meta> = { name: "状态 · 等待选择",
