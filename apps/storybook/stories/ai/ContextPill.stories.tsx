...
const meta = { title: 'AI/ContextPill', component: ContextPill, args: { label: 'design-language.md', children: 'design-language.md' }, render: args => <div className="flex min-w-0"><ContextPill {...args} /></div>, decorators: [Story => <StoryFrame><Story /></StoryFrame>] } satisfies Meta<typeof ContextPill>;
export default meta;
