...
const meta = { title: 'AI/Conversation', component: Conversation, args: { children: null }, decorators: [Story => <StoryFrame><Story /></StoryFrame>], parameters: { docs: { description: { component: '共享阅读宽度、消息角色与滚动跟随。Message 正文默认 14px / 24px 行高，两种密度字号一致，角色标签为 12px。用户向上阅读后暂停自动跟随，可用“回到最新”恢复。流式内容由宿主提供。' } } } } satisfies Meta<typeof Conversation>;
export default meta;
type Story = StoryObj<typeof meta>;
export const Guidelines: Story = { name: '交互场景：本地流式会话', render: () => <ConversationDemo /> };
...
export const LongConversation: Story = { name: '交互场景：长会话滚动跟随',
