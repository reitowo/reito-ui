...
const meta = { id: "ai-messagebranch", title: "AI/MessageBranch 消息分支", component: MessageBranch, args: { index: 0, count: 3, onIndexChange: fn() }, decorators: [Story => <StoryFrame><Story /></StoryFrame>], parameters: { docs: { description: { component: '零基索引由调用方持有。上一项和下一项在边界禁用；方向键、Home、End 支持键盘切换。组件只切换索引，不生成分支内容。' } } } } satisfies Meta<typeof MessageBranch>;
export default meta;
type Story = StoryObj<typeof meta>;
export const Guidelines: Story = { name: "交互 · 分支键盘切换",
...
export const Disabled: Story = { name: "状态 · 禁用", args: { index: 1, disabled: true } };
