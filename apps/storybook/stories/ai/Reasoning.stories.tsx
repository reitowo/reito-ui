...
const meta = { title: 'AI/Reasoning', component: Reasoning, args: { children: '这段过程说明由调用方提供。组件仅呈现内容、折叠状态和经过时间。', elapsedSeconds: 6 }, decorators: [Story => <StoryFrame><Story /></StoryFrame>] } satisfies Meta<typeof Reasoning>;
export default meta;
...
export const LocalTimer: Story = { name: '交互场景：本地计时', render: () => <ReasoningDemo /> };
