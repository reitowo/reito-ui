...
const meta = { title: 'AI/Sources', component: Sources, args: { items: demoSources }, decorators: [Story => <StoryFrame><Story /></StoryFrame>], parameters: { docs: { description: { component: '行内 Citation 与来源列表。内容和链接由调用方提供；不进行搜索或生成来源。不接受 javascript: 或 data: 链接。' } } } } satisfies Meta<typeof Sources>;
export default meta;
