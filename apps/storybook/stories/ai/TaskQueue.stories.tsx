...
const meta = { id: "ai-taskqueue", title: "AI/TaskQueue 任务队列", component: TaskQueue, args: { tasks: demoQueueTasks, onPause: fn(), onResume: fn(), onCancel: fn(), onRetry: fn() }, decorators: [Story => <StoryFrame><Story /></StoryFrame>], parameters: { docs: { description: { component: '队列任务、计数和筛选的展示组合。任务状态始终由宿主提供；暂停、继续、取消、重试调用宿主回调。本地示例不创建后台任务。' } } } } satisfies Meta<typeof TaskQueue>;
export default meta;
...
export const Guidelines: Story = { name: "交互 · 暂停、取消与筛选",
...
export const Default: Story = { name: "状态 · 运行中", args: { tasks: [{ id: 'layout', title: '检查工作区布局', description: '本地队列状态示例', status: 'running' }] } };
