...
const meta = { id: "ai-tokenusage", title: "AI/TokenUsage 用量统计", component: TokenUsage, args: { sourceLabel: '手动提供的示例数据', input: 1280, output: 346, contextUsed: 8120, contextLimit: 32000 }, decorators: [Story => <StoryFrame><Story /></StoryFrame>], parameters: { docs: { description: { component: '纯展示组件。数值由调用方提供，必须注明来源。不根据字符数、消息数或本地模拟输出伪造模型用量。缺失值显示破折号。' } } } } satisfies Meta<typeof TokenUsage>;
export default meta;
