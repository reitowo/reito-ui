...
const meta = { id: "基础-colorpicker",
  title: "基础/ColorPicker 颜色选择",
...
export const Overview: Story = { name: "总览对比", render: () => <ColorPickerDemo /> };
...
export const Formats: Story = { name: "格式 · HEX · RGB · HSL", render: () => <div className="grid max-w-lg gap-[var(--rui-content-gap)]"><ColorInput label="HEX" defaultValue="#4F7DFF" format="hex" /><ColorInput label="RGB" defaultValue="#4F7DFF" format="rgb" /><ColorInput label="HSL" defaultValue="#4F7DFF" format="hsl" /></div> };
...
export const ReadOnly: Story = { name: "状态 · 只读", render: () => <ColorPicker label="锁定颜色" value="#4F7DFF" readOnly description="保留可复制文本，关闭色板入口。" className="max-w-md" /> };
export const Disabled: Story = { name: "状态 · 禁用", render: () => <ColorPicker label="不可用颜色" value="#4F7DFF" disabled className="max-w-md" /> };
