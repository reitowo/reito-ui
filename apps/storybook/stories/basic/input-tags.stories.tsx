...
const meta = { id: "基础-inputtags",
  title: "基础/InputTags 标签输入",
  component: InputTags,
  tags: ['autodocs'],
  args: { label: '项目标签' },
...
export const Overview: Story = { name: "总览对比", render: () => <InputTagsDemo /> };
...
export const ReadOnly: Story = { name: "状态 · 只读", render: () => <ControlledTags readOnly /> };
export const Disabled: Story = { name: "状态 · 禁用", render: () => <ControlledTags disabled /> };
