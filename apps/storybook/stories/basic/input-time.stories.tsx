...
const meta = { id: "基础-inputtime",
  title: "基础/InputTime 时间输入",
  component: InputTime,
  tags: ['autodocs'],
  args: { label: '提醒时间' },
...
export const Overview: Story = { name: "总览对比", render: () => <InputTimeDemo /> };
...
export const ReadOnly: Story = { name: "状态 · 只读", render: () => <ControlledTime readOnly /> };
export const Disabled: Story = { name: "状态 · 禁用", render: () => <ControlledTime disabled /> };
