...
export const ReadOnly: Story = { name: '只读', args: { label: 'CPU 使用率', value: 43, readOnly: true, tone: 'success', formatValue: value => `${value}%`, description: '只读监测可保留相同视觉。' } };
export const Disabled: Story = { name: '禁用', args: { label: '已锁定配额', value: 35, disabled: true, formatValue: value => `${value}%` } };
