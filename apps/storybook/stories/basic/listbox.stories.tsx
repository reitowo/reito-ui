...
const meta = { id: "基础-listbox",
  title: "基础/Listbox 列表选择",
  component: Listbox,
  tags: ['autodocs'],
...
export const Overview: Story = { name: "总览对比", render: () => <ListboxDemo /> };
...
export const ReadOnly: Story = { name: "状态 · 只读", render: () => <Stateful label="已锁定技术栈" options={options} selectionMode="multiple" initialValue={['react', 'typescript']} readOnly /> };
