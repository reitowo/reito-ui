...
const meta = { id: "基础-meter", title: "基础/Meter 计量", component: MeterDemo, tags: ['autodocs'], parameters: { docs: { description: { component: '本地 Base UI Meter 组合，语义为有界测量值（role=meter），不是任务执行的 Progress。以标签、数值文字与说明补足颜色含义。' } } } } satisfies Meta<typeof MeterDemo>;
export default meta;
