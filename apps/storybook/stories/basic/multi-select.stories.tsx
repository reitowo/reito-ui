...
const meta = { id: "基础-multiselect", title: "基础/MultiSelect 多选", component: MultiSelect, tags: ['autodocs'], args: { label: '项目技术栈', options }, parameters: { docs: { description: { component: '本地多选封装。分组、创建新项、当前筛选结果全选/半选、批量清除和禁用项边界由公共 props 提供；批量操作不会改动当前结果外的值。' } } } } satisfies Meta<typeof MultiSelect>;
export default meta;
...
export const Disabled: Story = { name: "状态 · 禁用", render: () => <MultiSelectDemo state="disabled" /> };
