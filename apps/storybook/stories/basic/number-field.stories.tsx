...
export const Disabled: Story = { name: '禁用', render: () => <NumberField label="并发任务数" defaultValue={2} min={1} max={8} disabled className="max-w-sm" /> };
export const Invalid: Story = { name: '错误说明', args: { state: 'invalid' } };
export const Empty: Story = { name: '可空数值', args: { state: 'empty' } };

export const ReadOnly: Story = { name: '只读', render: () => <NumberField label="只读配额" value={8} readOnly className="max-w-sm" /> };
