...
const meta = { id: "基础-passwordinput",
  title: "基础/PasswordInput 密码输入",
...
export const Overview: Story = { name: "总览对比", render: () => <PasswordInputDemo /> };
...
export const ReadOnly: Story = { name: "状态 · 只读", render: () => <ControlledPassword rules={rules} readOnly /> };
export const Disabled: Story = { name: "状态 · 禁用", render: () => <ControlledPassword rules={rules} disabled /> };
