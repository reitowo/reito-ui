...
export const ReadOnly: Story = { name: '只读', args: { 'aria-label': '只读任务说明', readOnly: true, defaultValue: '已经确认的本地任务说明。', className: 'max-w-sm' } };
export const Disabled: Story = { name: '禁用', args: { 'aria-label': '不可编辑的说明', disabled: true, defaultValue: '已归档任务', className: 'max-w-sm' } };
export const Invalid: Story = { name: '错误', args: { 'aria-label': '任务说明', 'aria-invalid': true, defaultValue: '任务' }, render: args => <Field data-invalid className="max-w-sm"><Textarea {...args} aria-describedby="textarea-invalid-error" /><FieldError id="textarea-invalid-error">请补充任务目标和验收条件。</FieldError></Field> };
