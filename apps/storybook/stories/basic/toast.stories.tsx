...
const meta = { id: "基础-toast", title: "基础/Toast 轻提示", component: ToastDemo, tags: ['autodocs'], parameters: { docs: { description: { component: '本地 Base UI Toast 组合。Provider、焦点、F6 导航、公告、计时器和移除语义均由 Base UI 管理；示例 timeout=0 便于检查。' } } } } satisfies Meta<typeof ToastDemo>;
export default meta;
