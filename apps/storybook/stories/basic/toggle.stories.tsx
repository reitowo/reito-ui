...
const meta = { id: "基础-toggle",
  title: "基础/Toggle 切换按钮",
  component: Toggle,
  tags: ["autodocs"],
  parameters: {
    docs: {
...
export const Default: Story = { name: "默认示例", args: { 'aria-label': '粗体', children: <Bold /> } };
...
export const Disabled: Story = { name: "状态 · 禁用", args: { 'aria-label': '粗体', disabled: true, children: <Bold /> } };
