...
const meta = { title: '复杂/AsyncTreeView 异步树', component: AsyncTreeView } satisfies Meta<typeof AsyncTreeView>;
export default meta;
...
export const Loading: Story = { args: { nodes: [{ id: 'remote', label: 'remote', loadable: true }], defaultExpanded: ['remote'], label: '加载中的项目树', loadChildren: () => new Promise(() => undefined) } };
export const Empty: Story = { args: { nodes: [{ id: 'empty', label: 'empty', loadable: true }], defaultExpanded: ['empty'], label: '空子节点项目树', loadChildren: async () => { await wait(120); return []; } } };
