...
const meta = { id: "复杂-commandsearch-命令搜索", title: "复杂/CommandSearch 命令搜索", component: CommandSearchDemo, parameters: { docs: { description: { component: 'CommandSearch 提供分组、关键词匹配、异步/错误状态与当前上下文。ApplicationSearch 将它放入受控 Dialog，提供全局快捷键、异步动作、失败恢复和焦点归还；结果与副作用均由宿主注入。' } } } } satisfies Meta<typeof CommandSearchDemo>;
export default meta;
type Story = StoryObj<typeof meta>;
export const Interactive: Story = {
  name: "交互 · 搜索、空态、IME 与执行",
...
export const Loading: Story = { name: "状态 · 加载中", render: () => <CommandSearch groups={[]} onSelect={() => {}} loading /> };
