...
const meta = { id: "复杂-disclosuretree-目录导航", title: "复杂/DisclosureTree 目录导航", component: DisclosureTreeDemo, parameters: { docs: { description: { component: '原生 details/summary 折叠目录。Tab 逐项移动，Enter/Space 展开目录；叶节点支持受控选中与禁用。它不是具有方向键模型的 ARIA tree。' } } } } satisfies Meta<typeof DisclosureTreeDemo>;
export default meta;
