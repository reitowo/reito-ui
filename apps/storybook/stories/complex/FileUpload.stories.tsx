...
const meta = { id: "复杂-fileupload-文件上传", title: "复杂/FileUpload 文件上传", component: FileUploadDemo, parameters: { docs: { description: { component: '保留本地类型、大小、数量与重复校验，并通过宿主 transport 执行上传。队列明确 queued/uploading/success/error/canceled、进度、开始、取消、重试与逐文件错误；组件自身不实现网络协议。' } } } } satisfies Meta<typeof FileUploadDemo>;
export default meta;
...
export const Disabled: Story = { name: "状态 · 禁用", render: () => <FileUpload value={queued()} disabled transport={simulatedTransport} /> };
