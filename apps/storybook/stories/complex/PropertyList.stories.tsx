...
const meta = { id: "复杂-propertylist-属性编辑", title: "复杂/PropertyList 属性编辑", component: PropertyListDemo, parameters: { docs: { description: { component: '逐字段编辑器，支持文本、数字、布尔、选项和日期适配，嵌套路径、草稿通知、自定义验证、逐项只读/禁用与 Escape 取消。确认中文输入法候选不会触发表单保存。' } } } } satisfies Meta<typeof PropertyListDemo>;
export default meta;
