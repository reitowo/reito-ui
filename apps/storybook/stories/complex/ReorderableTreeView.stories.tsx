...
const meta = { title: '复杂/ReorderableTreeView 树重排', component: ReorderableTreeView } satisfies Meta<typeof ReorderableTreeView>;
export default meta;
...
export const Narrow: Story = { args: { ...Playground.args }, render: function Render(args) { const [nodes, setNodes] = useState(args.nodes); return <div className="w-56 max-w-full"><ReorderableTreeView {...args} nodes={nodes} onMove={intent => { const next = moveTreeNode(nodes, intent); if (next) setNodes(next); }} /></div>; } };
