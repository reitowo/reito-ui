...
const meta = { id: "复杂-searchfilterbar-搜索筛选", title: "复杂/SearchFilterBar 搜索筛选", component: SearchFilterBarDemo, parameters: { docs: { description: { component: 'query 和 selected 由调用方控制。示例按名称、负责人和状态过滤本地任务，可组合条件并清除全部。' } } } } satisfies Meta<typeof SearchFilterBarDemo>;
export default meta;
type Story = StoryObj<typeof meta>;
export const Interactive: Story = { name: "交互 · 真实筛选与结果列表" };
