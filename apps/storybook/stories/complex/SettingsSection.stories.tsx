...
const meta = { id: "复杂-settingssection-设置分组", title: "复杂/SettingsSection 设置分组", component: SettingsSectionDemo, parameters: { docs: { description: { component: 'SettingsSection 和 SettingsRow 负责分组布局。表单标签、受控状态、持久化由调用方提供。此示例包含输入、开关、禁用项和本地保存反馈。' } } } } satisfies Meta<typeof SettingsSectionDemo>;
export default meta;
