...
const meta = { title: '复杂/SortableList 排序列表', component: SortableList, tags: ['autodocs'], args: { items: sortableItems }, parameters: { docs: { description: { component: '稳定 ID 顺序支持选择后移动、Alt+方向键和原生拖放。禁用项保持位置并阻断跨越。' } } } } satisfies Meta<typeof SortableList>;
export default meta;
...
export const Overview: Story = { name: '总览', render: () => <SortableListDemo /> };
...
export const ReadOnly: Story = { name: '只读', render: () => <SortableList items={sortableItems} defaultSelected={['plan']} readOnly /> };
export const Disabled: Story = { name: '禁用', render: () => <SortableList items={sortableItems} defaultSelected={['plan']} disabled /> };
