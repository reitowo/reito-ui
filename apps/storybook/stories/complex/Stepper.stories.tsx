...
const meta = { title: '复杂/Stepper 分步流程', component: StepperDemo, parameters: { docs: { description: { component: 'value 和 onValueChange 控制当前步骤。校验与允许跳转规则由调用方提供；示例含必填信息、偏好和最终确认。' } } } } satisfies Meta<typeof StepperDemo>;
export default meta;
type Story = StoryObj<typeof meta>;
export const Interactive: Story = { name: '交互场景：有状态的配置流程' };
