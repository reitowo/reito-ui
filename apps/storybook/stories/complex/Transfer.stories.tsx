...
export const Overview: Story = { name: '总览', render: () => <TransferDemo /> };
...
export const ReadOnly: Story = { name: '只读', render: () => <Transfer items={transferItems} defaultValue={['read', 'terminal']} readOnly /> };
export const Disabled: Story = { name: '禁用', render: () => <Transfer items={transferItems} defaultValue={['read']} disabled /> };
export const Loading: Story = { name: '加载中', render: () => <Transfer items={transferItems} defaultValue={['read']} loading /> };
