...
const meta = { id: "复杂-treeselect-树选择",
...
export const Overview: Story = { name: "总览对比", render: () => <TreeSelectDemo /> };
...
export const Disabled: Story = { name: "状态 · 禁用", render: () => <TreeSelect nodes={demoNodes} value="button" disabled label="入口文件" /> };
