...
const meta = { id: "复杂-treetable-树表格",
...
export const Overview: Story = { name: "总览对比", render: () => <TreeTableDemo /> };
...
export const Loading: Story = { name: "状态 · 加载中", render: () => <TreeTable nodes={treeTableNodes} columns={treeTableColumns} loading caption="加载项目" /> };
