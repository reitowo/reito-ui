...
const meta = { id: "复杂-treeview-树形导航", title: "复杂/TreeView 树形导航", component: TreeView } satisfies Meta<typeof TreeView>;
export default meta;
...
export const Empty: Story = { name: "状态 · 空内容", args: { nodes: [], label: '空项目树' } };
export const Disabled: Story = { name: "状态 · 禁用", args: { nodes: demoNodes, expanded: ['src', 'components'], value: 'button', label: '含禁用节点的项目树' } };
export const Collapsed: Story = { name: "状态 · 已收起", args: { nodes: demoNodes, expanded: [], label: '折叠项目树' } };
export const Narrow: Story = { name: "布局 · 窄屏", args: { nodes: [{ id: 'root', label: '特别长的工作区目录 workspace-components', children: [{ id: 'file', label: 'WorkspaceConfiguration.settings.tsx', description: '完整说明保留在标题中' }] }], expanded: ['root'], label: '窄项目树' }, render: args => <div className="w-52 max-w-full"><TreeView {...args} /></div> };
