...
const meta = { id: "复杂-workspace-工作区布局", title: "复杂/Workspace 工作区布局", component: WorkspaceDemo, parameters: { docs: { description: { component: 'AppShell 定义自由外壳，WorkspacePane 拥有单个滚动内容区，ResizableWorkspace 保留基础两栏缩放。WorkspacePreset 提供导航、主工作面和检查器槽位，在窄布局切换单面板；useWorkspacePresetState 独立保存显隐与当前面板。' } } } } satisfies Meta<typeof WorkspaceDemo>;
export default meta;
