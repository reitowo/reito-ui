...
基础版不提供缩放、拖动画布、旋转、翻转、浏览器全屏或下载。这些查看器操作在 GALLERY-02 中单独定义，避免基础画廊暗示宿主已经授予下载或全屏能力。

[Storybook 参数调试](http://127.0.0.1:6006/?path=/story/基础-imagegallery-图片画廊--playground) 可在同一 Story 调整活动项、预览开关、缩略图、循环与禁用；加载、失败、空态和窄屏均有独立 Story。
