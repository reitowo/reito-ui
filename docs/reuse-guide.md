...
0.4 当前提供基础 58、复杂 22、AI 19 个组件族。基础层中的 50 族来自固定 CLI 生成，Toast、MultiSelect、NumberField、Meter、InputTags、AsyncCombobox、AsyncMultiSelect 与 ColorPicker / ColorInput 是本库实现的 8 族；具体契约见 [组件分层](component-layering.md)。
