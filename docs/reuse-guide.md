...
0.4 当前提供基础 66、复杂 22、AI 19 个组件族。基础层中的 50 族来自固定 CLI 生成，Toast、MultiSelect、NumberField、Meter、MeterGroup / ProgressGroup、Rating、InputTags、AsyncCombobox、AsyncMultiSelect、ColorPicker / ColorInput、InputDate、InputTime、DateTimePicker、PasswordInput、InputMask 与 Listbox 是本库实现的 16 族；具体契约见 [组件分层](component-layering.md)。
