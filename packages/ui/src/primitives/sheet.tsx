...
function SheetOverlay({ className, ...props }: SheetPrimitive.Backdrop.Props) {
  return (
    <SheetPrimitive.Backdrop
      ...
      className={cn(
        "fixed inset-0 z-[var(--rui-z-dialog)] bg-[var(--rui-overlay)] transition-opacity duration-[var(--rui-duration-normal)] data-ending-style:opacity-0 data-starting-style:opacity-0 supports-backdrop-filter:backdrop-blur-[var(--rui-blur-overlay)]",
        className
      )}
      {...props}
    />
